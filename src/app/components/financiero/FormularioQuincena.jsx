  ...
  return (
    <div className='space-y-4'>
      ...
      <SeccionGastos
        ...
        onAgregar={(concepto, recurrente) => onAgregarItem('obligaciones', concepto, recurrente)}
      ...
      <SeccionGastos
        ...
        onAgregar={(concepto, recurrente) => onAgregarItem('gastosPersonales', concepto, recurrente)}
